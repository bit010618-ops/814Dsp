...
def test_chapter_one_handout_reflows_all_component_inputs_without_source_identity(tmp_path: Path):
    ...
    assert component_paths[8].name == "chapter_01_convolution_basics_mathjax_component.pdf"
    assert component_paths[9].name == "chapter_01_convolution_properties_mathjax_component.pdf"
