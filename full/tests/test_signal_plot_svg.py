...
def test_stem_svg_uses_the_zero_index_as_the_vertical_axis_when_zero_is_sampled(tmp_path: Path):
    ...
    assert 'data-first-sample-clearance="false"' in svg
    ...
    assert axis_match.group(1) == stem_match.group(1)
