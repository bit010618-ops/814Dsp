...
<text x="70" y="300" class="s25-title">有限宽脉冲采样：副本受脉冲宽度包络加权</text><path class="s25-axis" d="M70 450H830" marker-end="url(#s25-freq-arrow)"/><path class="s25-axis" d="M450 472V330" marker-end="url(#s25-freq-arrow)"/>
