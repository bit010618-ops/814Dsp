...
<section class="exam-page"><div class="exam-head"><span>2013、2015 年真题</span><span>详解见 P.____</span></div>
<p>2013 年第六题／2015 年第五题：离散系统的单位脉冲响应 \(h(n)=\delta(n)-0.98\delta(n-6)\)，求系统函数 \(H(z)\)，画出零极点图和该系统的幅频特性。</p></section>'''
    )
...
<section><h2>2013、2015 年真题：由单位脉冲响应求零极点与幅频特性</h2>
