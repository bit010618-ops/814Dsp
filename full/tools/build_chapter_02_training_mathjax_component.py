...
def _zero_pole_svg() -> str:
    return r'''<svg viewBox="0 0 520 270" role="img" aria-label="零极点图：原点零点、实轴 2 处极点与单位圆">
...
<line x1="74" y1="140" x2="449" y2="140" stroke="#234d70" stroke-width="1.4" marker-end="url(#arrow)"/><line x1="196" y1="226" x2="196" y2="48" stroke="#234d70" stroke-width="1.4" marker-end="url(#arrow)"/>
<circle cx="196" cy="140" r="68" fill="none" stroke="#7d8d98" stroke-width="1.15"/><circle cx="196" cy="140" r="6" fill="white" stroke="#0e7490" stroke-width="2"/><path d="M324 132l16 16m0-16l-16 16" stroke="#b56b2e" stroke-width="2.5"/>
<text x="453" y="146" font-size="16" fill="#1f2933">Re</text><text x="202" y="56" font-size="16" fill="#1f2933">Im</text><text x="202" y="159" font-size="14" fill="#52616b">0</text><text x="260" y="159" font-size="14" fill="#52616b">1</text><text x="330" y="159" font-size="14" fill="#52616b">2</text><text x="184" y="63" font-size="13" fill="#52616b">单位圆</text><text x="349" y="125" font-size="13" fill="#b56b2e">极点</text><text x="166" y="126" font-size="13" fill="#0e7490">零点</text>
</svg>'''


def _am_svg() -> str:
    return r'''<svg viewBox="0 0 540 360" role="img" aria-label="离散时间正弦调制、频谱搬移和相干解调框图">
<defs><marker id="arrow" markerWidth="7" markerHeight="7" refX="6" refY="3.5" orient="auto"><path d="M0,0 L7,3.5 L0,7z" fill="#234d70"/></marker></defs>
<text x="30" y="25" font-size="15" fill="#315d7c">(a) 正弦调制</text><line x1="54" y1="61" x2="176" y2="61" stroke="#234d70" stroke-width="1.4" marker-end="url(#arrow)"/><circle cx="201" cy="61" r="19" fill="white" stroke="#234d70" stroke-width="1.4"/><path d="M190 50l22 22m0-22l-22 22" stroke="#b56b2e" stroke-width="1.5"/><line x1="220" y1="61" x2="362" y2="61" stroke="#234d70" stroke-width="1.4" marker-end="url(#arrow)"/><line x1="201" y1="104" x2="201" y2="80" stroke="#234d70" stroke-width="1.2" marker-end="url(#arrow)"/><text x="53" y="52" font-size="15">x(n)</text><text x="335" y="52" font-size="15">y(n)</text><text x="143" y="121" font-size="14">cos(ω<tspan baseline-shift="sub" font-size="10">c</tspan>n)</text>
<text x="30" y="155" font-size="15" fill="#315d7c">(b) 频谱搬移</text><line x1="50" y1="253" x2="500" y2="253" stroke="#234d70" stroke-width="1.3" marker-end="url(#arrow)"/><line x1="275" y1="264" x2="275" y2="172" stroke="#234d70" stroke-width="1.3" marker-end="url(#arrow)"/><path d="M210 253 L243 191 L275 253 M275 253 L307 191 L340 253" fill="none" stroke="#0e8d93" stroke-width="2"/><path d="M50 253 L83 191 L115 253 M435 253 L467 191 L500 253" fill="none" stroke="#0e8d93" stroke-width="2"/><text x="276" y="181" font-size="14">Y(e<tspan baseline-shift="super" font-size="10">jω</tspan>)</text><text x="267" y="276" font-size="12">0</text><text x="205" y="276" font-size="12">−ω<tspan baseline-shift="sub" font-size="9">c</tspan></text><text x="328" y="276" font-size="12">ω<tspan baseline-shift="sub" font-size="9">c</tspan></text><text x="506" y="258" font-size="14">ω</text>
<text x="30" y="307" font-size="15" fill="#315d7c">(c) 相干解调与低通恢复</text><line x1="54" y1="337" x2="160" y2="337" stroke="#234d70" stroke-width="1.4" marker-end="url(#arrow)"/><circle cx="183" cy="337" r="19" fill="white" stroke="#234d70" stroke-width="1.4"/><path d="M172 326l22 22m0-22l-22 22" stroke="#b56b2e" stroke-width="1.5"/><line x1="202" y1="337" x2="264" y2="337" stroke="#234d70" stroke-width="1.4" marker-end="url(#arrow)"/><rect x="269" y="314" width="109" height="45" rx="3" fill="white" stroke="#234d70" stroke-width="1.4"/><line x1="378" y1="337" x2="470" y2="337" stroke="#234d70" stroke-width="1.4" marker-end="url(#arrow)"/><text x="52" y="328" font-size="14">y(n)</text><text x="289" y="343" font-size="15">H(e<tspan baseline-shift="super" font-size="10">jω</tspan>)</text><text x="439" y="328" font-size="14">x̂(n)</text><text x="118" y="356" font-size="12">cos(ω<tspan baseline-shift="sub" font-size="9">c</tspan>n+θ<tspan baseline-shift="sub" font-size="9">c</tspan>)</text>
</svg>'''
