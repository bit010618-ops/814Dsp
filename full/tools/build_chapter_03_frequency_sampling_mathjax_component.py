...
<text x="367" y="93" fill="#52616d" font-family="Microsoft YaHei, sans-serif" font-size="15">DTFT 后在单位圆取 N 个等间隔样点</text><text x="818" y="161" fill="#52616d" font-family="Microsoft YaHei, sans-serif" font-size="14">N 点 IDFT</text><foreignObject x="82" y="148" width="95" height="28"><div xmlns="http://www.w3.org/1999/xhtml" style="font-size:14px">\\(N\\geq M\\)</div></foreignObject><text x="151" y="170" fill="#52616d" font-family="Microsoft YaHei, sans-serif" font-size="15">：副本不重叠，可恢复有限长序列。</text><foreignObject x="82" y="183" width="95" height="28"><div xmlns="http://www.w3.org/1999/xhtml" style="font-size:14px">\\(N&lt;M\\)</div></foreignObject><text x="151" y="205" fill="#52616d" font-family="Microsoft YaHei, sans-serif" font-size="15">：相隔 N 的样本相加，产生时域混叠。</text>
